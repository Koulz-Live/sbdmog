      ...
      <div className="d-flex gap-2 mb-3">
        ...
        <button
          ...
          onClick={async () => {
            ...
            try {
              const res = await apiPost<{ data: PopiaEvent[]; ai: { model: string } }>('/popia-events/ai-generate', {});
              track('ai_generate', { resource_type: 'popia_events', metadata: { model: res.ai.model, count: res.data.length } });
              await refetch();
              setAiSuccess(`${res.data.length} event${res.data.length !== 1 ? 's' : ''} generated by ${res.ai.model}`);
            } catch (e: any) {
